...
public partial class FuminiHotelManagementContext : DbContext
{
    ...
    private string GetConnectionString()
    {
        IConfiguration config = new ConfigurationBuilder()
            ...
            .Build();
        return config.GetConnectionString("DefaultConnection") ?? throw new Exception("Connecting string not found!!");
    }

    // Get Admin Email and Password from appsettings.json in line AppSettings:AdminEmail and AppSettings:AdminPassword
    private static string GetAdminEmail()
    {
        IConfiguration config = new ConfigurationBuilder()
            ...
            .AddJsonFile("appsettings.json", true, true)
            .Build();
        return config["AppSettings:AdminEmail"] ?? throw new Exception("Admin Email not found!!");
    }
    ...
    private static string GetAdminPassword()
    {
        IConfiguration config = new ConfigurationBuilder()
            ...
            .AddJsonFile("appsettings.json", true, true)
            .Build();
        return config["AppSettings:AdminPassword"] ?? throw new Exception("Admin Password not found!!");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A147400161BAED").IsUnique();
    ...
    {
        var admin = Customers.FirstOrDefault(Customers => Customers.EmailAddress == GetAdminEmail());
        if (admin == null)
        {
